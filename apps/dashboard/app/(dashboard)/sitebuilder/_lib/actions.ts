...
export function selectTheme(themeKey: string): Promise<ActionResult<SiteConfigDto>> {
...
export function removeSection(id: string): Promise<ActionResult> {
...
export function publishNow(note?: string): Promise<ActionResult<SiteVersionDto>> {
  return run(() => api.post<SiteVersionDto>('/v1/sitebuilder/publish', { note }));
}

export function rollback(versionId: string): Promise<ActionResult<SiteVersionDto>> {
...
export function cancelSchedule(id: string): Promise<ActionResult<SitePublishScheduleDto>> {
