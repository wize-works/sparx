...
import { ArrowLeft, Package2, PackageOpen } from 'lucide-react';
        ...
        <Card>
          <CardHeader>
            <Stack gap={1}>
              ...
              <CardDescription>
                Edit pricing, inventory mode, and component list. Saving replaces the entire
                component list (small + simple beats diffing).
              </CardDescription>
            </Stack>
          </CardHeader>
          <CardContent>
