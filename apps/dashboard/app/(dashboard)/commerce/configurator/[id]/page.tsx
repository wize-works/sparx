...
import { ArrowLeft, PackageOpen, Settings2 } from 'lucide-react';
        ...
        <Card>
          <CardHeader>
            <Stack gap={1}>
              ...
              <CardDescription>
                {template.rules.length} rule{template.rules.length === 1 ? '' : 's'} that
                hide/require options or adjust price as selections change.
              </CardDescription>
            </Stack>
          </CardHeader>
          <CardContent>
