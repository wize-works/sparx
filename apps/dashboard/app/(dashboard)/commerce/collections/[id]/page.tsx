...
import { ArrowLeft, Layers, PackageOpen, Sparkles, Star } from 'lucide-react';
...
export default async function CollectionDetailPage({ params }: PageProps) {
  ...
  // For manual collections, render the membership picker with the
  // tenant's product list. For rules collections, the products list is
  // read-only (it's whatever the indexer projected) and the rule editor
