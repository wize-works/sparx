...
import { gateHandler, type ConsumerContext } from './registry.js';
import { resolveCustomerByAuthUserId } from './projection.js';
...
export function registerAuthEventConsumers(ctx: ConsumerContext): Array<() => void> {
...
export const AUTH_CONSUMER_TOPICS = Object.keys(AUTH_MAP) as Array<keyof typeof AUTH_MAP>;
